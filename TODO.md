...
- Sous-titres automatiques anglais visibles sur certaines vidéos malgré
  ...
  toujours.
- `Suivi.tsx` (la rubrique « Ta semaine » de l'accueil) écrit
  `rgba(62,146,200,0.25)` en dur : un doublon du bleu `--mobilite` à 25 %. Il
  correspond aujourd'hui, mais ne suivra pas si le jeton change.
